...
socket.on("meta", function(data) {
  ...
  <img src="https://muensterchat.glitch.me/api/${data.meta_content[i].name}/pic.png?${thingTick}" style="width: 48px;height: 48px;border-radius: 10px;display: inline-block;">
